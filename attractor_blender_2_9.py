...
class AizawaAttractor(Object_OT_Attractor):
    ...
    def iterate(self, x, y, z):
        ...
        dz = self.c + self.a * z - (pow(z, 3) / 3) - (
            pow(x, 2) + pow(y, 2)) * (1 + self.e * z) + self.f * z * pow(x, 3)
        return (dx, dy, dz)
...
class ThreeLayerAttractor(Object_OT_Attractor):
    ...
    def iterate(self, x, y, z):
        b = ((self.d * self.a2 * self.a2 * self.c3 * self.c3) /
             (32 * self.a3 * self.a3 * self.c2 * self.c2)) * math.sqrt(
                 (-self.a3 * self.c2) / (self.a1 * self.c1))
        c = ((self.a2 * self.a2 * self.c3 * self.c3) /
             (4 * self.a3 * self.c2) -
             (self.a3 * self.c1 + self.a1 * self.c2) * b / self.d) / self.a2
...
class ChuaMultiIIAttractor(Object_OT_Attractor):
    ...
    def iterate(self, x, y, z):
        sum = 0
        for k in range(1, 6):
            sum += ((self.m[k - 1] - self.m[k]) *
                    (abs(x + self.c[k]) - abs(x - self.c[k])))
...
class StrizhakKawczynskiAttractor(Object_OT_Attractor):
    ...
    def iterate(self, x, y, z):
        xn = self.r * (y - (x - self.ax1) * (x - self.ax2) *
                       (x - self.ax3) - self.a)
...
class Menu_MT_AttractorMenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("curve.anishenko_astakhov_attractor_add",
                        text="Anishenko-Astakhov")
        ...
        layout.operator("curve.chencelikovsky_attractor_add",
                        text="Chen-Celikovsky")
        ...
        layout.operator("curve.chuamultiii_attractor_add",
                        text="Chua Multi II")
        ...
        layout.operator("curve.lotka_volterra_attractor_add",
                        text="Lotka-Volterra")
        layout.operator("curve.moorespiegel_attractor_add",
                        text="Moore Spiegel")
        layout.operator("curve.newjerk_attractor_add", text="New-Jerk")
        layout.operator("curve.newtonleipnik_attractor_add",
                        text="Newton-Leipnik")
        layout.operator("curve.nosehoover_attractor_add", text="Nose-Hoover")
        layout.operator("curve.rabinovichfabrikant_attractor_add",
                        text="Rabinovich-Fabrikant")
        layout.operator("curve.rayleighbenard_attractor_add",
                        text="Rayleigh-Benard")
        ...
        layout.operator("curve.shimizumorioka_attractor_add",
                        text="Shimizu-Morioka")
        layout.operator("curve.sprottd_attractor_add", text="Sprott D")
        layout.operator("curve.sprotte_attractor_add", text="Sprott E")
        layout.operator("curve.sprottlinzb_attractor_add",
                        text="Sprott-Linz B")
        layout.operator("curve.sprottlinzc_attractor_add",
                        text="Sprott-Linz C")
        layout.operator("curve.sprottlinzf_attractor_add",
                        text="Sprott-Linz F")
        layout.operator("curve.sprottlinzg_attractor_add",
                        text="Sprott-Linz G")
        layout.operator("curve.sprottlinzh_attractor_add",
                        text="Sprott-Linz H")
        layout.operator("curve.sprottlinzi_attractor_add",
                        text="Sprott-Linz I")
        layout.operator("curve.sprottlinzj_attractor_add",
                        text="Sprott-Linz J")
        layout.operator("curve.sprottlinzk_attractor_add",
                        text="Sprott-Linz K")
        layout.operator("curve.sprottlinzl_attractor_add",
                        text="Sprott-Linz L")
        layout.operator("curve.sprottlinzm_attractor_add",
                        text="Sprott-Linz M")
        layout.operator("curve.sprottlinzo_attractor_add",
                        text="Sprott-Linz O")
        layout.operator("curve.sprottlinzp_attractor_add",
                        text="Sprott-Linz P")
        layout.operator("curve.sprottlinzq_attractor_add",
                        text="Sprott-Linz Q")
        layout.operator("curve.sprottlinzs_attractor_add",
                        text="Sprott-Linz S")
        layout.operator("curve.sprottn_attractor_add", text="Sprott N")
        layout.operator("curve.sprottr_attractor_add", text="Sprott R")
        layout.operator("curve.strizhakkawczynski_attractor_add",
                        text="Strizhak-Kawczynski")
        layout.operator("curve.thomas_attractor_add", text="Thomas")
        layout.operator("curve.threecellscnn_attractor_add",
                        text="Three-Cells-CNN")
