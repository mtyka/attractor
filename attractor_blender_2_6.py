...
class Attractor(bpy.types.Operator):
...
class CoulletAttractor(Attractor):
...
class RoesslerAttractor(Attractor):
...
class ThreeCellsCNNAttractor(Attractor):
...
class AnishenkoAstakhovAttractor(Attractor):
...
class BoualiAttractor(Attractor):
...
class BurkeShawAttractor(Attractor):
...
class LotkaVolterraAttractor(Attractor):
  ## John S. Costello 
...
class MooreSpiegelAttractor(Attractor):
...
class RikitakeAttractor(Attractor):
  ## Tyler McMillen
...
class RabinovichFabrikantAttractor(Attractor):
...
class ThreeLayerAttractor(Attractor):
...
class ChuaMultiIAttractor(Attractor):
...
class ChuaMultiIIAttractor(Attractor):
...
class ChenLeeAttractor(Attractor):
...
class FinanceAttractor(Attractor):
...
class ChenCelikovskyAttractor(Attractor):
...
class DequanLiAttractor(Attractor):
...
class YuWangAttractor(Attractor):
...
class HadleyAttractor(Attractor):
...
class LinzSprottAttractor(Attractor):
...
class LorenzMod1Attractor(Attractor):
...
class LorenzMod2Attractor(Attractor):
...
class NewtonLeipnikAttractor(Attractor):
...
class NoseHooverAttractor(Attractor):
...
class RayleighBenardAttractor(Attractor):
...
class RucklidgeAttractor(Attractor):
...
class WangSunAttractor(Attractor):
...
class NewJerkAttractor(Attractor):
...
class SakaryaAttractor(Attractor):
...
class SprottDAttractor(Attractor):
...
class SprottEAttractor(Attractor):
...
class SprottLinzBAttractor(Attractor):
...
class SprottLinzCAttractor(Attractor):
...
class SprottLinzFAttractor(Attractor):
...
class SprottLinzGAttractor(Attractor):
...
class SprottLinzHAttractor(Attractor):
...
class SprottLinzIAttractor(Attractor):
...
class SprottLinzJAttractor(Attractor):
...
class SprottLinzKAttractor(Attractor):
...
class SprottLinzLAttractor(Attractor):
...
class SprottLinzMAttractor(Attractor):
...
class SprottLinzOAttractor(Attractor):
...
class SprottLinzPAttractor(Attractor):
...
class SprottLinzQAttractor(Attractor):
...
class SprottLinzSAttractor(Attractor):
...
class SprottNAttractor(Attractor):
...
class SprottRAttractor(Attractor):
...
class StrizhakKawczynskiAttractor(Attractor):
